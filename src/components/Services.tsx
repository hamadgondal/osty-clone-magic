      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Comprehensive creative solutions tailored to bring your vision to life with cutting-edge technology and innovative design
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} rounded-3xl transition-opacity opacity-0 group-hover:opacity-100`} />
